...
def find_closest_mass_file(directory, target_mass):
	closest_mass = None
	...
	if abs(closest_mass-target_mass)/target_mass>0.1:
		raise Warning('No stellar model within 10 percent of specified initial mass found.')
